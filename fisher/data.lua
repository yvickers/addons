...
data.item_fishing_parameters = {
    ...
    -- entities
    {name='jade etui', id=70002, stamina=11, arrow_duration=11, arrow_frequency=15, stamina_depletion=16, size=1},
    -- key items
    --{name='lance fish', id=70003, stamina=22, arrow_duration=5, arrow_frequency=10, stamina_depletion=30},
    --{name='paladin lobster', id=70004, stamina=40, arrow_duration=10, arrow_frequency=7, stamina_depletion=30},
    --{name='scutum crab', id=70005, stamina=56/60, arrow_duration=15, arrow_frequency=15, stamina_depletion=25},
}
