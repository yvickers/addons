...
commands.auto = function()
    if settings.auto_fight ~= 'on' then
        settings.auto_fight = 'on'
    else
        settings.auto_fight = 'off'
    end
    windower.add_to_chat(settings.add_to_chat_mode, 'AutoFight: ' .. settings.auto_fight)
end
